...
class MetricName(MetricNameBase):
    ...
    TIED_PAIR_RATE = "tied_pair_rate"
    EFFECTIVE_TRAINING_EXAMPLE_RATE = "effective_training_example_rate"
    DEGENERATE_SESSION_FRACTION = "degenerate_session_fraction"
    SESSION_GROUP_SIZE_MEAN = "session_group_size_mean"
    SESSION_GROUP_SIZE_MAX_PER_BATCH = "session_group_size_max_per_batch"
    SINGLETON_SESSION_FRACTION = "singleton_session_fraction"
