...
class BaseRwEmbeddingSharding(EmbeddingSharding[C, F, T, W]):
    ...
    def _get_virtual_table_feature_num_buckets(self) -> Tuple[List[int], bool]:
        ...
        return feature_num_buckets, has_virtual_tables
...
class RwSparseFeaturesDist(BaseSparseFeaturesDist[KeyedJaggedTensor]):
    ...
    def _get_bucketize_row_pos(
        ...
        #   Tensor([0, 2, 4, 6, 7, 8, 9]), Feature 2 has 2 buckets on ranks 0, 1, 2. 3 buckets on ranks 3, 4, 5
        # ]
...
class RwPooledEmbeddingSharding(
    ...
    def create_input_dist(
        ...
        virtual_table_feature_num_buckets, has_virtual_tables = (
        ...
        return RwSparseFeaturesDist(
            ...
            has_virtual_tables=has_virtual_tables,
        )
