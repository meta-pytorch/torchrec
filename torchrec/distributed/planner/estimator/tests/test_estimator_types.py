...
class ShardPerfContextTest(unittest.TestCase):
    ...
    def test_batch_outputs_sparse_vbe_scaling(self) -> None:
        ...
        smaller, accounting for sparse VBE features where only a fraction
        of samples have data.
        """
        ctx = ShardPerfContext(
    ...
    def test_batch_outputs_dense_features_unaffected(self) -> None:
        ...
        # min(1,10)*1*32 + min(1,20)*2*32 = 32+64 = 96
        self.assertEqual(ctx.batch_outputs, 96.0)
