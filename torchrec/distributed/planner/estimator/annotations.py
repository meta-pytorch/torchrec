...
def _matches_sharding_type(method: Callable[..., float], sharding_type: str) -> bool:
    ...
    Returns:
        True if the method applies to this sharding type (either matches or has no restriction)
    """
...
def _get_annotated_method(
    ...
    for attr_name in dir(config):
        ...
        if method and callable(method) and getattr(method, annotation_attr, False):
...
def forward_compute(
    method_or_sharding_type: Optional[Union[Callable[..., float], str]] = None,
    *,
    sharding_type: Optional[str] = None,
) -> Union[
    ...
    def _apply_decorator(
        method: Callable[..., float], target_sharding_type: Optional[str]
    ) -> Callable[..., float]:
    ...
    # Case 3: @forward_compute('table_wise') - positional argument
    if isinstance(method_or_sharding_type, str):
...
def backward_compute(
    ...
    *,
    ...
    # Case 3: @backward_compute('table_wise') - positional argument
    if isinstance(method_or_sharding_type, str):
        target_sharding_type = method_or_sharding_type
...
def input_dist_comms(
    ...
    *,
    ...
    # Case 3: @input_dist_comms('table_wise') - positional argument
    if isinstance(method_or_sharding_type, str):
        target_sharding_type = method_or_sharding_type
...
def fwd_comms(
    ...
    *,
    ...
    # Case 3: @fwd_comms('table_wise') - positional argument
    if isinstance(method_or_sharding_type, str):
        target_sharding_type = method_or_sharding_type
...
def bwd_comms(
    ...
    *,
    ...
    # Case 3: @bwd_comms('row_wise') - positional argument
    if isinstance(method_or_sharding_type, str):
        target_sharding_type = method_or_sharding_type
...
def output_write_size(
    ...
    *,
    ...
    # Case 3: @output_write_size('table_wise') - positional argument
    if isinstance(method_or_sharding_type, str):
        target_sharding_type = method_or_sharding_type
