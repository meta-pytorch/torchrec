...
class EmbeddingShardingPerfEvaluator(ABC):
    ...
    def _default_prefetch_comp(
        ...
        if (
            ...
            # Set expected_lookups and expected_unique_lookups for linear regression
        ...
        # DEBUG: Log prefetch computation
        logger.info(
            ...
            f"use_linear_regression={use_linear_regression}, "
...
class EmbeddingPerfEstimatorV2:  # TODO rename this later
    ...
    def estimate(
        ...
        for sharding_option in sharding_options:
            ...
            shard_perfs = [shard.perf for shard in sharding_option.shards]
