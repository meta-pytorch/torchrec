...
Usage:
    ...
    # Cloud deployment (via TorchX)
    torchx run -s kubernetes dist.ddp -j 1x8 --script train_torchrec_quickstart.py
    ...
    def __iter__(
        ...
        for _ in range(self.num_batches):
            ...
            for _ in range(self.num_sparse_features):
                ...
                values = torch.randint(0, self.num_embeddings, (lengths.sum().item(),))
