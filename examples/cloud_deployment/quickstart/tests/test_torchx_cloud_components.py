...
"""
Tests for TorchX cloud deployment components (AWS, Azure, GCP).
...
from torchrec.github.examples.cloud_deployment.aws.torchx_aws_component import (
    run_dlrm_aws,
    run_dlrm_aws_spot,
)
from torchrec.github.examples.cloud_deployment.azure.torchx_azure_component import (
    run_dlrm_azure,
    run_dlrm_azure_spot,
)
from torchrec.github.examples.cloud_deployment.gcp.torchx_gcp_component import (
    run_dlrm_gcp,
