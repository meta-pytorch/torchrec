...
└── gcp/
    ...
    ├── torchx_gcp_component.py # TorchX component for GCP
...
1. **Install TorchX** (for job orchestration):
   ```bash
...
|----------|-------|---------------|
| AWS | [aws/README.md](aws/README.md) | `torchx run -s kubernetes -cfg queue=aws ...` |
| Azure | [azure/README.md](azure/README.md) | `torchx run -s kubernetes -cfg queue=azure ...` |
| GCP | [gcp/README.md](gcp/README.md) | `torchx run -s kubernetes -cfg queue=gcp ...` |
...
│   │  GPU Cluster│    │   Dataset   │    │   TorchX    │    │    Job      │             │
│   │  (EKS/AKS/  │    │  (S3/Blob/  │    │  Component  │    │             │             │
│   │   GKE)      │    │   GCS)      │    │             │    │             │             │
│   └─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘             │
│                                                                                         │
│   2. TRAINING PHASE                                                                     │
